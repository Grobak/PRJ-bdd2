                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            ...
                                            <div class="vehicle-block-content">
                                                ...
                                                <a href="results-list-copie.php" title="View all Sedans" class="vehicle-body-type"><img src="images/body-types/sedan.png" width="30" alt=""></a>
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            ...
                                            <div class="vehicle-block-content">
                                                ...
                                                <a href="results-list-copie.php" title="View all SUVs" class="vehicle-body-type"><img src="images/body-types/suv.png" width="30" alt=""></a>
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            ...
                                            <div class="vehicle-block-content">
                                                ...
                                                <a href="results-list-copie.php" title="View all convertibles" class="vehicle-body-type"><img src="images/body-types/convertible.png" width="30" alt=""></a>
                                    ...
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            ...
                                            <div class="vehicle-block-content">
                                                ...
                                                <a href="results-list-copie.php" title="View all coupes" class="vehicle-body-type"><img src="images/body-types/coupe.png" width="30" alt=""></a>
